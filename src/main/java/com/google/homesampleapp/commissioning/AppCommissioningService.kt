  ...
  override fun onCommissioningRequested(metadata: CommissioningRequestMetadata) {
    ...
    serviceScope.launch {
        ...
        try {
            ...
            Timber.d("Commissioning: Starting device commissioning...")
            chipClient.awaitCommissionDevice(deviceId, null)

            Timber.d("Commissioning: Sending commissioning complete...")
            val completeMetadata = CommissioningCompleteMetadata.builder()
                .setToken(deviceId.toString())
                .build()
            
            commissioningServiceDelegate
                .sendCommissioningComplete(completeMetadata)
                .addOnSuccessListener {
                    Timber.d("Commissioning: Successfully sent commissioning complete")
                }
                .addOnFailureListener { e ->
                    Timber.e(e, "Commissioning: Failed to send commissioning complete")
                    commissioningServiceDelegate
                        .sendCommissioningError(CommissioningError.OTHER)
                        .addOnSuccessListener {
                            Timber.d("Commissioning: Sent commissioning error after complete failure")
                        }
                }
        } catch (e: Exception) {
            Timber.e(e, "Commissioning failed")
            commissioningServiceDelegate
                .sendCommissioningError(CommissioningError.OTHER)
                .addOnSuccessListener {
                    Timber.d("Commissioning: Sent commissioning error after failure")
                }
                .addOnFailureListener { e2 ->
                    Timber.e(e2, "Commissioning: Failed to send commissioning error")
                }
        }
    }
  }
